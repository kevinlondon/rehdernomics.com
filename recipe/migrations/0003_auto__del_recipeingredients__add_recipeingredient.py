...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipe_recipeingredient', (
        ...
        db.send_create_signal(u'recipe', ['RecipeIngredient'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'recipe_recipeingredient')
