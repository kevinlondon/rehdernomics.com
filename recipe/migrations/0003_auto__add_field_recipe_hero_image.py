...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recipe.hero_image'
        db.add_column(u'recipe_recipe', 'hero_image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recipe.hero_image'
        db.delete_column(u'recipe_recipe', 'hero_image')
    ...
    models = {
        ...
        u'recipe.recipe': {
            ...
            'hero_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
