...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'recipe_recipeingredients', (
            ...
            ('ingredient_state', self.gf('django.db.models.fields.CharField')(default='', max_length=30, null=True)),
        ))
        db.send_create_signal(u'recipe', ['RecipeIngredients'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'recipe_recipeingredients')
    ...
    models = {
        ...
        u'recipe.recipe': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredients': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['recipe.Ingredient']", 'through': u"orm['recipe.RecipeIngredients']", 'symmetrical': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '40'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        },
        u'recipe.recipeingredients': {
            'Meta': {'object_name': 'RecipeIngredients'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingredient': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['recipe.Ingredient']"}),
            'ingredient_state': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '30', 'null': 'True'}),
